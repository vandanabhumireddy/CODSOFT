...
b2 = ttk.Button(root, text='Edit',width=20,command=edit)
b3 = ttk.Button(root, text='Delete', width=20, command=delOne)
b4 = ttk.Button(root, text='Delete all', width=20, command=deleteAll)
b5 = ttk.Button(root, text='Exit', width=20, command=bye)
